...
interface State extends LanguageType { }

class HeaderComponnet extends React.Component<
  RouteComponentProps & WithTranslation,
  State
> {
  constructor(props: (LanguageType & RouteComponentProps & WithTranslation<"translation">) | Readonly<RouteComponentProps & WithTranslation<"translation">>) {
    super(props);
    const storeState = store.getState() as LanguageType;
    this.state = {
